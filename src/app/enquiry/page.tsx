                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                    <label className="flex items-start gap-2 cursor-pointer flex-1">
                      <input
                        ...
                        className="mt-0.5 accent-[#00509d] shrink-0"
                      />
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="shrink-0 px-10 py-2.5 text-sm font-bold text-white transition hover:opacity-90 disabled:opacity-60 rounded"
                      style={{ background: "#00509d" }}
                    >
