  ...
  return (
    <div style={{ minHeight: "60vh", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "sans-serif" }}>
      <div style={{ textAlign: "center", padding: "2rem" }}>
        <h1 style={{ fontSize: "4rem", fontWeight: "900", color: "#E8274B", margin: 0 }}>404</h1>
        ...
        <Link
          href="/"
          style={{ display: "inline-block", marginTop: "1.5rem", padding: "0.75rem 2rem", background: "linear-gradient(135deg,#E8274B,#F4822A)", color: "#fff", borderRadius: "0.75rem", textDecoration: "none", fontWeight: "bold" }}
        >
          Go Home
        </Link>
      </div>
