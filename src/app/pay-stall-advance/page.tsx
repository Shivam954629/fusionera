...
export default function PayStallAdvancePage() {
  ...
  return (
    ...
    >
      ...
      <p className="mt-4 text-lg leading-8 " style={{ color: "#0c1148" }}>
      ...
      <h3 className="mt-8 text-xl font-bold" style={{ color: "#0c1148" }}>
        Contact Our Team
      </h3>
      <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
        <div
          className="rounded-xl p-5 bg-white"
          style={{ border: "1px solid rgba(12,17,72,0.1)" }}
        >
          <p className="text-sm font-bold" style={{ color: "#0c1148" }}>
            Delhi
          </p>
          <p
