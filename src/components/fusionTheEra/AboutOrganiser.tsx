...
const FALLBACK_PARAS = [
  "Fusion The Era is organized by V-Tech Innovation Services, a company committed to creating impactful business exhibitions and industry-focused networking platforms across India.",
  "With a strong vision to connect manufacturers, suppliers, distributors, and trade buyers through professionally managed B2B trade events, V-Tech Innovation Services brings together its deep industry knowledge, extensive network, and operational expertise to deliver high-quality exhibition experiences.",
  ...
  "Fusion The Era 2027, the first edition of this landmark trade show, is being held at Bharat Mandapam, Pragati Maidan, New Delhi from June 15 to 18, 2027 — bringing together India's finest houseware, HORECA ware, stainless steel, home appliances, and allied industries under one prestigious roof.",
];
