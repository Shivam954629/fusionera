        ...
        <div className="relative grid gap-6 p-6 text-[#1b2440] md:p-8">
          <div>
            ...
            <p className="mt-4 text-md leading-7 text-justify text-[#1b2440]/85">
              ...
              Metro, railway stations, and Indira Gandhi International Airport,
              making travel smooth and accessible from across India and
              overseas.
            </p>
            <p className="mt-4 text-md leading-7 text-justify text-[#1b2440]/85">
              Venue Details <br />
            ...
            <p className="mt-4 text-md leading-7 text-justify text-[#1b2440]/85">
              ...
              hospitality facilities conveniently located around the venue area.
            </p>
          </div>
        </div>
      </div>
