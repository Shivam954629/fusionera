      ...
      <div className="mx-auto grid w-[92%] max-w-7xl gap-8 md:grid-cols-4">
        <div>
          ...
          <p className="mt-4 text-sm leading-6 text-[#d8e6ff]">
            ...
            Stainless Steel and Home Appliances. India's premier B2B trade show
            for Houseware, HoReCa, Home Décor & Kitchen. Organized by V-Tech
            Innovation Services.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="mt-4 grid gap-2 text-sm text-[#e7f0ff]">
            <a href="#featured" className="transition hover:text-[#8cecff]">
              About The Show
            </a>
            ...
            <a href="#contact" className="transition hover:text-[#8cecff]">
