      ...
      <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;border-radius:12px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.08);">
        ...
        <div style="background:#fff;padding:36px 40px;text-align:center;">
          ...
          <p style="color:#6b7280;font-size:14px;line-height:1.6;margin:0 0 24px;">
            Dear <strong>${fullName}</strong>, you are successfully registered for Fusionera 2026.<br/>
            Your entry pass details will be shared on your phone/email soon.
          </p>
            ...
            <tr>
              <td style="padding:20px 24px;">
                ...
                <table cellpadding="6" cellspacing="0" width="100%">
                  <tr>
                    <td style="color:#6b7280;font-size:13px;width:40%;">📅 Dates</td>
                    <td style="color:#1a1560;font-size:13px;font-weight:600;">July 4–6, 2026</td>
                  </tr>
                  <tr>
                    <td style="color:#6b7280;font-size:13px;">📍 Location</td>
                    <td style="color:#1a1560;font-size:13px;font-weight:600;">New Delhi, India</td>
                  </tr>
                  <tr>
                    <td style="color:#6b7280;font-size:13px;">🎟️ Entry</td>
                    <td style="color:#00c9a7;font-size:13px;font-weight:600;">Free Entry</td>
                  </tr>
                </table>
              </td>
            </tr>
        ...
        <div style="background:#f8f9ff;padding:16px 40px;text-align:center;border-top:1px solid #e5e7eb;">
          <p style="color:#9ca3af;font-size:11px;margin:0;">© 2026 Fusionera — Perfect Business Platform. All rights reserved.</p>
        </div>
      </div>
    `,
  });
...
async function sendAdminEmail(
  ...
  await transporter.sendMail({
    ...
    subject: `🔔 New Visitor Registered — ${fullName}`,
    html: `
      <div style="font-family:Arial,sans-serif;max-width:520px;margin:0 auto;border-radius:12px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.08);">
        <div style="background:linear-gradient(135deg,#110c41,#1a1560);padding:24px 32px;">
          ...
          <p style="color:#a5b4fc;margin:6px 0 0;font-size:12px;">Fusionera 2026 — Admin Notification</p>
        </div>
        <div style="background:#fff;padding:28px 32px;">
          <table cellpadding="10" cellspacing="0" width="100%" style="border-collapse:collapse;">
            <tr style="border-bottom:1px solid #f0f0f0;">
              <td style="color:#6b7280;font-size:13px;width:40%;">👤 Full Name</td>
              <td style="color:#1a1560;font-weight:600;font-size:13px;">${fullName}</td>
            </tr>
            <tr style="border-bottom:1px solid #f0f0f0;">
              <td style="color:#6b7280;font-size:13px;">📞 Phone</td>
              <td style="color:#1a1560;font-weight:600;font-size:13px;">${phoneNumber}</td>
            </tr>
            <tr>
              <td style="color:#6b7280;font-size:13px;">📧 Email</td>
              <td style="color:#1a1560;font-weight:600;font-size:13px;">${email || "—"}</td>
            </tr>
          </table>
        </div>
